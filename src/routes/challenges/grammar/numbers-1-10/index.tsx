...
const quizItems: StrictQuizItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'ثلاثُ\nthalāthu — masculine form, wrong here',
      'ثلاثتانِ\nthalāthatāni — invalid form',
  ...
  },
  {
    ...
    options: [
      ...
      'ثلاثةُ\nthalāthatu — feminine form, wrong here',
      'ثلاثانِ\nthalāthāni — invalid form',
  ...
  },
  {
    ...
    options: [
      ...
      'اثنانِ\nithnāni — masculine dual "two," wrong here',
      'ثنتا\nthintā — invalid construct form here',
      'اثنينِ\nithnayni — نصب/جر form, wrong case here',
    ],
    correctIndex: 0,
