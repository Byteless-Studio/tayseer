...
const quizItems: StrictQuizItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'طالبانِ\nṭālibāni — dual, رفع',
      'طالبينِ\nṭālibīni',
      'طالبونَ\nṭālibūna — sound masculine plural',
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'هذانِ الطالبانُ مجتهدانِ\nhādhāni ṭ-ṭālibānu mujtahidāni',
  ...
  },
  {
    ...
    options: [
      ...
      'المجتهدانِ\nal-mujtahidāni — dual masculine',
      'المجتهدتينِ\nal-mujtahidatayni — that\'s the نصب/جر form',
      'المجتهدةُ\nal-mujtahidatu — singular',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'معلمتانِ\nmuʿallimatāni — that\'s the رفع form',
      'معلماتٍ\nmuʿallimātin — sound feminine plural',
      'معلمةٍ\nmuʿallimatin — singular',
    ],
    correctIndex: 0,
