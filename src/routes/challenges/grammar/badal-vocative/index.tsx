...
const quizItems: StrictQuizItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'خالدٌ\nKhālidun — nominative',
      'خالدٍ\nKhālidin — genitive',
      'خالدَ\nKhālida — accusative without تنوين, incorrect here since خالد is not a diptote',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'يا محمداً أقبِلْ\n"O Muhammad, come here" — wrongly put in the accusative',
    ],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'خالداً\nKhālidan — accusative',
      'خالدٍ\nKhālidin — genitive',
      'خالدَ\nKhālida — accusative without تنوين, incorrect here',
    ],
    correctIndex: 0,
