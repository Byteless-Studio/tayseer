...
const quizItems: StrictQuizItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'سأقابلُك اليومُ في المكتبةِ\nاليومُ should be accusative (اليومَ), not nominative',
    ],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: [
      'نفساً\nnafsan — accusative تمييز',
      'نفسٌ\nnafsun — nominative',
      'نفسٍ\nnafsin — genitive',
      'النفسَ\nan-nafsa — definite with أل',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      'عسلٍ\nʿasalin — indefinite genitive',
      'عسلاً\nʿasalan — accusative',
      'عسلٌ\nʿasalun — nominative',
      'العسلِ\nal-ʿasali — definite with أل',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'طابَ زيدٌ نفسٌ\nنفسٌ should be accusative (نفساً), not nominative',
    ],
    correctIndex: 3,
