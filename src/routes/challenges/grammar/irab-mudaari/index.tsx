...
const quizItems: StrictQuizItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'تكتبِ\ntaktubi — an incorrect vowel ending',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      'لن ينجحوا\nlan yanjaḥū — accusative, نون dropped (correct)',
      'لن ينجحون\nlan yanjaḥūna — nominative form, نون kept, incorrect after لن',
      'لن ينجحوهم\nlan yanjaḥūhum — the wrong word entirely',
  ...
  },
  {
    ...
    options: [
      ...
      'تهملُ\ntuhmilu — nominative, incorrect here',
      'تهملَ\ntuhmila — accusative, incorrect here',
      'أهملْ\nahmil — the wrong person/conjugation',
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'هو يذهبُ إلى العمل\nhuwa yadhhabu ilā l-ʿamali — "He goes to work" (no accusative-marker, nominative correct)',
  ...
  },
  {
    ...
    options: [
      ...
      'تجتهدُ\ntajtahidu — nominative, incorrect here',
      'تجتهدَ\ntajtahida — accusative, incorrect here',
      'اجتهدْ\nijtahid — imperative, the wrong form',
    ],
    correctIndex: 0,
